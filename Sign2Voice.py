...
class Application:
    ...
    def __init__(self):
       ...
       # counter = 0
        ...
        self.panel.place(x=50, y=3, width=380, height=440)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=580, y=90, width=300, height=300)

        self.T = tk.Label(self.root)
        self.T.place(x=45, y=5)
        self.T.config(text="Sign Language To voice Conversion", font=("Courier", 28, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=280, y=455)

        self.T1 = tk.Label(self.root)
        self.T1.place(x=10, y=450)
        self.T1.config(text="Character :", font=("Courier", 30, "bold"))

        self.panel5 = tk.Label(self.root)  # word
        self.panel5.place(x=260, y=500)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=10, y=495)
        self.T3.config(text="Word :", font=("Courier", 30, "bold"))
        
        #self.panel5 = tk.Label(self.root) # Sentence
        #self.panel5.place(x = 10, y = 540)

        #self.T5 = tk.Label(self.root)
        #self.T5.place(x = 10, y = 535)
        #self.T5.config(text = "Sentence :",font = ("Courier", 30, "bold"))
        

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=580)
        
        #self.T4.config(text="Suggestions :", fg="red", font=("Courier", 30, "bold"))


        #self.b1=tk.Button(self.root)
       # self.b1.place(x=290,y=580)

        #self.b2 = tk.Button(self.root)
        #self.b2.place(x=490, y=580)

        #self.b3 = tk.Button(self.root)
        #self.b3.place(x=690, y=580)

        #self.b4 = tk.Button(self.root)
        #self.b4.place(x=890, y=580)

        self.speak = tk.Button(self.root)
        self.speak.place(x=780, y=510)
        self.speak.config(text="Speak", font=("Courier", 20), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=900, y=510)
        self.clear.config(text="Clear", font=("Courier", 20), wraplength=100, command=self.clear_fun)
        
        image5 = Image.open("download.jfif")
        test = ImageTk.PhotoImage(image5)

        label5 = tk.Label(image=test)
        label5.image = test

        # Position image
        label5.place(x=950, y=150)
        # Resize the image using resize() method
        resize_image = image5.resize((300, 400))
        self.text_entry = tk.Entry(self.root)
        self.text_entry.pack()
        self.text_entry.place(x=60, y=570)
        # Create a language selection dropdown
        self.language_choice = tk.StringVar(self.root)
        self.language_choice.set("en")
        
        self.language_dropdown = tk.OptionMenu(self.root, self.language_choice, "en-us", "fr", "es", "de","hi")
        self.language_dropdown.pack()
        self.language_dropdown.place(x=60, y=590)
        self.speech_button = tk.Button(self.root, text="Multiligual Speech", command=self.convert_to_speech)
        self.speech_button.pack()
        self.speech_button.place(x=360, y=590)
#         self.text_entry.delete(tk.END)  # Clear existing text
#         hello = self.str
    ...
    def convert_to_speech(self):
        selected_language = self.language_choice.get()
...
#         self.speak_engine.runAndWait()
    ...
    def destructor(self):
        ...
        #self.text_entry.insert(tk.END, hello)
